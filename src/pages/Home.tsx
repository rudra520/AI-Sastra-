...
const Hero = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
        setStatsValue({ tools: 150, groups: 3, categories: 12, unified: 1 });
    }, 500);
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 px-4">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          Now in Development — Coming Soon
        </motion.div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    {CATEGORIES.map((cat, i) => (
                        ...
                        >
                            ...
                            <div className="text-[10px] text-zinc-500 mt-1 uppercase tracking-wider">{cat.tools.length} tools</div>
                        </Link>
                    ))}
                </div>
            </div>
...
export const Home = () => {
    return (
        <>
            ...
            <section className="py-24 sm:py-32 px-4 relative overflow-hidden bg-zinc-950">
                <div className="absolute inset-0 bg-gradient-to-r from-sastra-900/20 via-zinc-950 to-blue-900/20" />
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <h2 className="font-space font-bold text-4xl sm:text-6xl mb-8 text-white leading-tight">The AI World is Fragmented.<br/><span className="bg-gradient-to-r from-sastra-400 via-blue-400 to-pink-400 bg-clip-text text-transparent text-glow">Let's Unify It.</span></h2>
                    <p className="text-zinc-400 text-lg mb-12 max-w-2xl mx-auto">AI-Sastra makes the future accessible to everyone. From a child's first math tutor to a grandparent's first voice assistant.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link 
                            to="/signup"
                            className="px-10 py-5 bg-white text-zinc-950 font-bold rounded-full hover:scale-105 transition-transform flex items-center justify-center gap-3"
                        >
                            <Rocket className="w-5 h-5" />
                            Join the Early Access
                        </Link>
                        <button className="px-10 py-5 bg-zinc-900 text-white font-bold rounded-full border border-zinc-800 hover:border-zinc-700 flex items-center justify-center gap-3">
