...
import { Brain, Mail, Lock, LogIn, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-20">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-space font-bold text-white mb-2">Welcome Back</h1>
          <p className="text-zinc-400">Continue your AI-powered journey</p>
        </div>
        ...
        <div className="glass-morphism rounded-3xl p-8 border-zinc-800/50">
          ...
          <button
            ...
            className="w-full py-3.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white font-medium hover:bg-zinc-900 transition-all flex items-center justify-center gap-3"
          >
          ...
          <p className="mt-8 text-center text-zinc-500 text-sm">
            ...
            <Link to="/signup" className="text-sastra-400 font-semibold hover:text-sastra-300 transition-colors inline-flex items-center gap-1">
              Create account
