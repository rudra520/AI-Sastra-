...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Kids", isRoute: true, href: "/age/kids" },
    { name: "Adults", isRoute: true, href: "/age/adults" },
    { name: "Seniors", isRoute: true, href: "/age/seniors" },
  ];
          ...
          >
            ...
            <div className="mt-auto flex flex-col gap-3">
              {user ? (
                ...
                <Link to="/signup" onClick={() => setIsOpen(false)} className="w-full py-3 text-sm font-semibold bg-gradient-to-r from-sastra-600 to-blue-600 rounded-full text-white text-center">
                  Get Started
                </Link>
              )}
            </div>
...
<a href="https://github.com/rudra520"><GithubIcon className="w-5 h-5 text-zinc-600 hover:text-white cursor-pointer transition-colors" /></a>
 <a href="https://www.linkedin.com/in/rudra-pratap-singh-ba6ab637b/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BZF4qonWeRj%2BYXgeQC7pdPQ%3D%3D"><Linkedin className="w-5 h-5 text-zinc-600 hover:text-white cursor-pointer transition-colors" /></a>
                      </div>
                  </div>
                  <div>
                  ...
                  <div>
                      ...
                      <ul className="space-y-4 text-sm text-zinc-500">
                          ...
                          <li><a href="https://gold-fredia-71.tiiny.site" className="hover:text-white transition-colors">Contact</a></li>
                      </ul>
                  </div>
                   <div>
              ...
              <div className="pt-10 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6">
                  <p className="text-zinc-600 text-xs">© 2025 AI-Sastra. All rights reserved.
                                                        Founder & Developer - Rudra Pratap singh
                  </p>
